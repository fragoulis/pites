...
<p class="mb-5">Το πεδί Όμιλος δεν είναι υποχρεωτικός.</p>

<p class="mb-5">
	Τα πεδία <abbr class="font-bold">Ημ/νία εγγραφής</abbr> και
	<abbr class="font-bold">Έχει πληρώσει μέχρι</abbr> χρησιμοποιούνται για να δημιουργηθεί μία εγγραφή
	πληρωμής που να εμφανίζει το μέλος ως οικονομικά εντάξει μέχρι τότε.
</p>
